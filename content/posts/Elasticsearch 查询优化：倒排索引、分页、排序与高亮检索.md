---
title: Elasticsearch 查询优化：倒排索引、分页、排序与高亮检索
...
tags:
  ...
  - 查询优化
  - 后端开发
description: Elasticsearch 适合全文检索、日志搜索、商品搜索和复杂筛选，但查询写法、字段类型、分页方式和排序策略都会影响性能。通过一个搜索接口变慢的场景，整理倒排索引、text/keyword、bool 查询、分页、排序、高亮、mapping 和慢查询排查思路。
cover:
published: true
---
