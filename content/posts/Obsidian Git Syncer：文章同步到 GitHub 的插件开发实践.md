...
我在使用 Obsidian 写博客时，经常会遇到一个衔接问题：文章在 Vault 中完成后，怎样方便地发布到博客内容仓库？因为我已经有一个自己部署的博客网站。

我想要达到的最终效果是，博客开发上线之后，不需要再进行维护，平时写文章的时候，只需要专注于写作本身，在 Obsidian 里面进行文章的管理，完成之后一键上线到博客即可。
...
先看一下最终的效果，这是为博客简历的专门 Vault，编写固定格式的笔记属性，设置好标题、分类、标签、是否公开等属性，是一篇普通的文章写作：

![514](images/2026/07/24/img-20260724163159459.png)


写作完成后，打开菜单栏的插件同步中心，选择要发布的文章，点击同步即可上传 Github仓库：

![532](images/2026/07/24/img-20260724162835441.png)
